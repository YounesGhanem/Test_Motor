...
#define HALL_M1_Pin GPIO_PIN_0
#define HALL_M1_GPIO_Port GPIOC
#define HALL_M2_Pin GPIO_PIN_1
#define HALL_M2_GPIO_Port GPIOC
#define HALL_M3_Pin GPIO_PIN_2
#define HALL_M3_GPIO_Port GPIOC
